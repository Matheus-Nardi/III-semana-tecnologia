      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 lg:gap-16">
          <motion.div
            ...
            className="relative w-40 h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 animate-float"
          >
            ...
            <Image src="/ilustracoes/9_ilustracao.png" alt="Ilustração de uma baleia" fill className="object-contain" />
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 1 }}
            className="relative w-40 h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 animate-float-delayed"
          >
            <div className="absolute inset-0 -z-10 scale-150">
              <svg viewBox="0 0 200 200" className="w-full h-full">
                <defs>
            ...
            <Image src="/ilustracoes/3_ilustracao.png" alt="Ilustração decorativa" fill className="object-contain" />
          </motion.div>
        </div>
      </div>
    </section>
